...
urlpatterns = [
    ...
    path('vuelos/create', views.VueloCreate.as_view(), name='vuelo-create'),
    path('vuelos/<int:pk>/update/', views.VueloUpdate.as_view(), name='vuelo-update'),
    path('vuelos/<int:pk>/delete/', views.AvionDelete.as_view(), name='vuelo-delete'),
